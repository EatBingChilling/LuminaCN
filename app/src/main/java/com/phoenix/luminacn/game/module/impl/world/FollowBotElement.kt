...
class FollowBotElement : Element(
    ...
    private var followDistance by floatValue("距离", 2.0f, 1.0f..5.0f)
    private var followMode by intValue("模式", 0, 0..1) 
    private var speed by floatValue("速度", 3.0f, 1.0f..7.0f)

...
class VelocityElement(iconResId: Int = AssetManager.getAsset("ic_file_download_black_24dp")) : Element(
    ...
    private val mode by stringValue(this, "Mode", "Vanilla", listOf("Vanilla", "Percentage", "Blocks"))


    private val horizontalPercent by floatValue("横向 %", 80f, 0f..100f)
    private val verticalPercent by floatValue("竖向 %", 80f, 0f..100f)

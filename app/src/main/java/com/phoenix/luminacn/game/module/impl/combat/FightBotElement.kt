...
class FightBotElement(iconResId: Int = AssetManager.getAsset("ic_eye")) : Element(
    name = "Auto Fight",
    ...
    private var mode by intValue("模式", 1, 0..2) 
    ...
    private var attackEnabled by boolValue("攻击", true)
    private var attackInterval by intValue("攻击间隔", 5, 1..20)

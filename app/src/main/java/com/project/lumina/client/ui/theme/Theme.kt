...
// 使用系统默认字体，不再依赖自定义字体文件
val MyTypography = Typography(
    displayLarge = TextStyle(fontFamily = FontFamily.Default, fontSize = 57.sp),
    displayMedium = TextStyle(fontFamily = FontFamily.Default, fontSize = 45.sp),
    displaySmall = TextStyle(fontFamily = FontFamily.Default, fontSize = 36.sp),
    ...
    headlineSmall = TextStyle(fontFamily = FontFamily.Default, fontSize = 24.sp),
    ...
    titleSmall = TextStyle(fontFamily = FontFamily.Default, fontSize = 14.sp),
    ...
    labelMedium = TextStyle(fontFamily = FontFamily.Default, fontSize = 12.sp),
...
fun LuminaClientTheme(
    ...
    val colorScheme = when {
        ...
        else -> AppContext.themeManager.getMaterialColorScheme("light")
    }

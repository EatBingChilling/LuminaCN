package com.project.lumina.client.game.utils.constants
...
object ItemTags {
    ...
    init {
        ...
        val json = JsonParser.parseReader(ItemTags::class.java.getResourceAsStream("/mcpedata/item_tags.json").reader(Charsets.UTF_8)).asJsonObject

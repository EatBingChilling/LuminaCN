...
import com.project.luminacn.game.entity.MobList
...
class MinimapElement : Element(
    ...
    private val sizeOption by intValue("大小", 100, 60..300)

    
    private val zoomOption by floatValue("放大", 1.0f, 0.5f..2.0f)

    
    private val dotSizeOption by intValue("点大小", 5, 1..10)

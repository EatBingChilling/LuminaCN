...
import com.project.luminacn.game.event.EventManager
import com.project.luminacn.game.event.EventPacketInbound
import com.project.luminacn.game.registry.BlockMapping
import com.project.luminacn.game.registry.BlockMappingProvider
import com.project.luminacn.game.world.Level
import com.project.luminacn.game.world.World
import com.project.luminacn.overlay.mods.MiniMapOverlay
import com.project.luminacn.overlay.mods.OverlayModuleList
import com.project.luminacn.overlay.mods.PacketNotificationOverlay
import com.project.luminacn.overlay.mods.Position
import com.project.luminacn.overlay.mods.SessionStatsOverlay
import com.project.luminacn.overlay.mods.SpeedometerOverlay
import com.project.lumina.relay.LuminaRelaySession
import com.project.luminacn.game.registry.ItemMapping
import com.project.luminacn.game.registry.ItemMappingProvider
import com.project.luminacn.game.registry.LegacyBlockMapping
import com.project.luminacn.game.registry.LegacyBlockMappingProvider
import com.project.luminacn.overlay.mods.KeystrokesOverlay
import com.project.luminacn.overlay.mods.TargetHudOverlay
...
class NetBound(val luminaRelaySession: LuminaRelaySession) : ComposedPacketHandler, com.project.luminacn.game.event.Listenable {
    ...
    override fun beforePacketBound(packet: BedrockPacket): Boolean {
        ...
        displayClientMessage("[LuminaCN | ShiYi & Phoen1x_]", TextPacket.Type.TIP)

package com.project.luminacn.service
...
import com.project.luminacn.remlink.TerminalViewModel
import java.io.File
    ...
    companion object {
        ...
        private fun on(context: Context, captureModeModel: CaptureModeModel) {
            ...
            val currentActivity = activityManager.appTasks
                ...
                .firstOrNull()
            RemisOnline = currentActivity == "com.project.luminacn.activity.RemoteLinkActivity"
